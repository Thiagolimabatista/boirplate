  ...
  if (empty || !mail) {
    return (
      <EmptyContent
        ...
        description="Selecione uma conversa para ler"
    ...
    <Stack spacing={1} sx={{ p: 1, borderRadius: 1, bgcolor: 'background.neutral' }}>
      <Stack direction="row" alignItems="center" justifyContent="space-between">
        ...
        >
          ...
          {mail.attachments.length} {mail.attachments.length === 1 ? 'anexo' : 'anexos'}
          <Iconify
            icon={
        ...
        >
          <Iconify width={18} icon="eva:cloud-download-fill" /> Baixar
        </ButtonBase>
      </Stack>
