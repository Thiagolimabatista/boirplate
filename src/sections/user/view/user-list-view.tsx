...
const TABLE_HEAD = [
  ...
  { id: 'company', label: 'Departamento', width: 220 },
...
export function UserListView() {
  ...
  return (
    <>
                  ...
                  {dataFiltered
                    ...
                    .map((row) => (
                      <UserTableRow
                        ...
                        onViewHealth={() => handleViewHealth(row)}
                      />
                    ))}
      ...
      {selectedUser && (
        <UserHealthDialog
          open={healthDialog.value}
          onClose={healthDialog.onFalse}
          user={selectedUser}
        />
      )}
    </>
