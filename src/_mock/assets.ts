...
export const _postTitles = [
  ...
  `A Importância do Autocuidado: Pequenas Ações Diárias que Fazem Diferença`,
  `Como Identificar Sinais de Burnout e Buscar Ajuda`,
  `Meditação e Mindfulness: Benefícios para a Saúde Mental`,
  `Equilíbrio Entre Vida Pessoal e Profissional: Dicas Práticas`,
  `Saúde Mental no Trabalho: Quebrando o Tabu`,
  `5 Exercícios de Respiração para Reduzir a Ansiedade`,
  `A Importância do Diálogo Aberto sobre Sentimentos`,
  `Novos Benefícios de Bem-Estar Disponíveis na Empresa`,
  `Como Construir Relacionamentos Saudáveis no Trabalho`,
  `Dicas de Alimentação Saudável para Mais Energia no Dia a Dia`,
  `Ginástica Laboral: Exercícios Rápidos para Fazer no Escritório`,
  `Como Lidar com a Pressão e Prazos Apertados`,
  `A Importância de Tirar Férias e Desconectar`,
  `Apoio Psicológico Gratuito: Saiba Como Acessar`,
  `Técnicas para Melhorar a Qualidade do Sono`,
  `Como Falar com seu Gestor sobre Saúde Mental`,
  `Atividades de Team Building Focadas em Bem-Estar`,
  `Reconhecendo e Celebrando Pequenas Conquistas`,
  `O Poder da Gratidão: Exercícios Diários`,
  `Como Criar Limites Saudáveis no Ambiente de Trabalho`,
  `Programas de Apoio ao Funcionário: Conheça Seus Direitos`,
  `Dicas para Manter a Motivação em Tempos Difíceis`,
